...
<body>
<!--[if lte IE 9]>
<p class="browsehappy">amaze do not support this <strong>outdate </strong> explorer <a href="http://browsehappy.com/" target="_blank"></a></p>
<![endif]-->

<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
    <strong>让我们一起来拼车吧～！{{test_name}}</strong> <small></small>
  </div>
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        <li><a href="admin-index.html"><span class="am-icon-home"></span>我的线路</a></li>
        <li class="admin-parent">
          <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span>实时拼车信息 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="admin-user.html" class="am-cf"><span class="am-icon-check"></span>去程</a></li>
            <li><a href="admin-user.html" class="am-cf">回程</a></li>
          </ul>
        </li>
      </ul>
      ...
      <div class="am-panel am-panel-default admin-sidebar-panel">
        <div class="am-panel-bd">
          ...
          <p>拼车单程10元/人，费用仅为油费，不包含人身安全保险，拼车纯属自愿。</p>
        </div>
      </div>
